...
<body>
    <%--${user.userName},欢迎您，您当前积分为${user.credits};--%>
    ...
    <div class="container theme-showcase" role="main">
        <div class="jumbotron">
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <button type="button" class="btn btn-bt btn-primary">
                    <a href="<c:url value="/userFunction.html"/> ">权限控制</a>
                </button>
            </sec:authorize>
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <button type="button" class="btn btn-bt btn-primary">
                    <a href="<c:url value="/resume.html"/> ">人员简历/标书</a>
                </button>
            </sec:authorize>
            <button type="button" class="btn btn-bt btn-primary">
                <a href="<c:url value="/generalResource.html"/> ">公司共享资料库</a>
            </button>
        </div>
    </div>
</body>
